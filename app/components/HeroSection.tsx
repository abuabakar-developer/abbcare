  ...
  return (
    <section className="relative bg-gray-900 text-white py-12 sm:py-16 md:py-24 overflow-visible">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 relative z-10">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-snug bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">
            Trusted Healthcare for Everyone
          </h1>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg max-w-md mx-auto md:mx-0 text-gray-300">
  Our expert doctors provide top-notch medical care tailored to your needs. 
  Your health is our priority.
          ...
          <div className="flex justify-center md:justify-start">
            <motion.button
              ...
              className="mt-4 py-3 px-6 bg-green-600 text-white font-semibold text-sm sm:text-base md:text-lg lg:text-xl rounded-full hover:bg-green-700 shadow-lg transition duration-300 flex items-center gap-2"
            >
              Book Appointment
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-[-60px] w-full max-w-5xl bg-gray-800 bg-opacity-90 rounded-2xl shadow-xl px-8 py-6 flex flex-wrap justify-around items-center z-20 backdrop-blur-md border border-gray-700">
        <div className="flex flex-col items-center space-y-1">
          <UserIcon className="h-10 w-10 text-green-400" />
          <span className="text-2xl md:text-3xl font-bold text-green-400">
            +102
          </span>
          <span className="text-sm md:text-base text-gray-300">Doctors</span>
        </div>
        <div className="flex flex-col items-center space-y-1">
        ...
        <div className="flex flex-col items-center space-y-1">
          ...
          <span className="text-sm md:text-base text-gray-300">Treatments</span>
        </div>
      </div>
    </section>
  );
